...
#                $$BREAKPAD_PATH/client/mac/handler/minidump_generator.mm \
...
OBJECTIVE_SOURCES +=  $$BREAKPAD_PATH/client/mac/handler/minidump_generator.mm
...
macx:INCLUDEPATH += ../openssl-1.0.0d
macx:LIBS += -L$$PWD/../openssl-1.0.0d/mac -llibssl -llibcrypto
